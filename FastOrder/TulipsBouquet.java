 ...
 */
public class TulipsBouquet extends Bouquet {

    public TulipsBouquet() {
        FlowerSpec spec1 = new FlowerSpec(FlowerType.TULIP, 5, FlowerColor.RED, 12, 6.8);
        FlowerSpec spec2 = new FlowerSpec(FlowerType.TULIP, 4, FlowerColor.BLUE, 8, 18);
        FlowerSpec spec3 = new FlowerSpec(FlowerType.TULIP, 5, FlowerColor.YELLOW, 10, 7.9);
        ...
        bouquet.addFlowers(flw1, flw2, flw4, flw3);
    }
}
